...
export default function Profile() {
    ...
    function submit(values, actions) {
        ...
        axios.post('/api/providers/profile', form, {headers: {'Content-Type': 'multipart/form-data'}})
            .then((response) => {
                setSuccess(response.data.message);

                //TODO: use rtk query to reflect the changes to other pages
            ...
            .catch((error) => {
                ...
                if(error.response.status === 422){
                    ...
                    setError('عفواً حدث خطأ خلال تعديل بياناتك نرجو المحاولة لاحقاً')
                }
            })
    }
